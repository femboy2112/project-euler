...
UM_REPO="${UPPERMANAGEMENT_REPO:-$HOME/UpperManagement}"
...
D: shell-run EXACTLY: uppermanagement packet --repo $UM_REPO --seed 7 --format json --output /tmp/um-coexist.json
